            ...
            <div class="block block-rounded  block-transparent mb-0">
                <form @submit.prevent="submit">
                    ...
                    <div class="block-content font-size-sm">
                        ...
                        <div class="form-group ">
                            <label for="field-klasifikasi_id">Klasifikasi</label>
                                <b-form-select v-model="form.group_id" class="mb-3" :options="groupList"></b-form-select>
                            <div v-if="errors.code" class="invalid-feedback font-size-sm">{{ errors.code[0] }}</div>
                        </div>
                    ...
                    <div class="block-content block-content-full text-right border-top">
                        <b-button variant="danger" class="mr-1" @click="reset">Batal</b-button>
    ...
    export default {
        ...
        methods: {
            ...
            openModal() {
                this.editMode = false;
                this.modalShow = true;
                this.title = 'Tambah Jurnal Akun Baru';
            },
            submit: function () {
                let form = this.$inertia.form(this.form)
                let url = this.editMode ? this.route("accounting.config.account.update") : this.route(
                    "accounting.config.account.store");
                form.post(url, {
                    preserveScroll: true,
                    onSuccess: () => {
                        this.$swal.fire({
