        ...
        <div class="content">
            <div class="content-heading pt-0 mb-3">
                ...
                <div class="float-right">
                    ...
                    <Link class="btn btn-sm btn-secondary" :href="route('anggota.create')">
                        ...
                        <tbody v-else>
                            <template v-if="Object.values(dataList.data).length">
                                <tr v-for="data in dataList.data" :key="data.id">
                                    ...
                                    <td>{{ data.nama }}</td>
                                    <td>
                                        <div class="font-size-16 font-w600">No HP : {{ data.no_hp == null ? "—" :  data.no_hp }}</div>
                                        <div class="font-size-15">Email : {{ data.email == null ? "—" :  data.email }}</div>
                                    </td>
                                    <td>
                                    ...
                                    <td>{{ format_date(data.tgl_gabung) }}</td>
                                    <th>
