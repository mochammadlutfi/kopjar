    ...
    <BaseLayout>
        ...
        <div class="content">
            ...
            <div class="row gutters-tiny">
                ...
                <div class="col-md-6 col-xl-3">
                    <Link class="block block-rounded block-link-shadow" :href="route('simpanan.wajib.create')">
                        <div class="block-content block-content-full block-sticky-options">
                            <div class="block-options">
                                <div class="block-options-item">
                        ...
                        <tbody v-else>
                            <template v-if="Object.values(dataList.data).length">
                                <tr v-for="data in dataList.data" :key="data.id">
                                    ...
                                    <td>{{ format_periode(data.periode) }}</td>
                                    ...
                                    <th>
                                        <a class="btn btn-secondary btn-sm" :href="route('simpanan.wajib.show', data.id)">
