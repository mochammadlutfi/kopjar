    ...
    <BaseLayout>
        <!-- <div class="bg-body-light border-b">
            <div class="content py-5 text-center">
                <nav class="breadcrumb bg-body-light mb-0">
                    <span class="breadcrumb-item active">Penarikan Simpanan Sukarela</span>
                </nav>
            </div>
        </div> -->
        ...
        <div class="content">
            ...
            <div class="row gutters-tiny">
                ...
                <div class="col-md-6 col-xl-3">
                    <Link class="block block-rounded block-link-shadow" :href="route('simpanan.sukarela.withdraw.create')">
                        <div class="block-content block-content-full block-sticky-options">
                            <div class="block-options">
                                <div class="block-options-item">
...
export default {
    ...
    methods :{
        ...
        doSearch : _.throttle(function(){
            ...
            this.$inertia.get(this.route('simpanan.sukarela.withdraw.index', params))
        }, 200),
    }
}
</script>
