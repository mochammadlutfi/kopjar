                ...
                <div class="block-content">
                    <div class="row">
                        <div class="mb-4 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <div>ID Anggota :  <span class="font-w700">{{ data.anggota_id }}</span></div>
                            <div>Nama :  <span class="font-w700">{{ data.anggota.nama }}</span></div>
                            <div>Email :  <span class="font-w700">{{ data.anggota.email }}</span></div>
                            <div>No Handphone :  <span class="font-w700">{{ data.anggota.no_hp }}</span></div>
                        </div>
                        <div class="mb-4 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <div>Staff : <span class="font-w700">{{ data.teller.name }}</span></div>
                        </div>
                        <div class="mb-4 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <div>Tanggal : <span class="font-w700">{{ data.payment.tgl_bayar }}</span></div>
                        </div>
                    </div>
                </div>
