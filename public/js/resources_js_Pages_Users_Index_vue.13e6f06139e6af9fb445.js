...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    BaseLayout: _Layouts_Authenticated_vue__WEBPACK_IMPORTED_MODULE_1__["default"],
  ...
  methods: {
    doSearch: lodash__WEBPACK_IMPORTED_MODULE_2___default().throttle(function () {
      this.$inertia.get(this.route('settings.user.index', {
        search: this.search
      }));
    }, 200)
  }
...
var render = function() {
  ...
  return _c("BaseLayout", [
    _c("div", { staticClass: "bg-body-light border-b" }, [
      _c("div", { staticClass: "content py-5 text-center" }, [
        _c("nav", { staticClass: "breadcrumb bg-body-light mb-0" }, [
    ...
    _c("div", { staticClass: "content" }, [
        ...
        _c("div", { staticClass: "float-right" }, [
          _c(
            "button",
            {
              ...
              attrs: { type: "button", id: "tgl_range" }
            },
            [
              ...
              _vm._v(" "),
              _c("input", {
                attrs: { type: "hidden", id: "tgl_mulai", value: "" }
              }),
              _vm._v(" "),
              _c("input", {
                attrs: { type: "hidden", id: "tgl_akhir", value: "" }
              })
            ]
          )
        ])
      ...
      _c(
        ...
        {
          staticClass:
            "block block-rounded block-shadow block-bordered d-md-block d-none mb-10"
        },
        [
          _c("div", { staticClass: "block-content p-2" }, [
              ...
              _c("div", { staticClass: "col-4" }, [
                _c("div", { staticClass: "has-search" }, [
                  ...
                  _c("input", {
                    ...
                    attrs: { type: "search", id: "search-data-list" },
                ...
                _c("div", { staticClass: "row" }, [
                  _c(
                    "div",
                    {
                      ...
                      attrs: { id: "content-nav" }
                    },
                    [
                      _c("span", [
                        _vm._v(
                          _vm._s(_vm.dataList.from) +
                            "-" +
                            _vm._s(_vm.dataList.to) +
                            "/" +
                            _vm._s(_vm.dataList.total)
                        )
                      ])
                    ]
                  ),
                  ...
                  _c(
                    "div",
                    { staticClass: "col-md-4 pt-25 pl-0" },
                    [
                      _c(
                        "Link",
                        {
                          staticClass: "btn btn-alt-secondary float-right",
                          attrs: {
                            href: _vm.dataList.next_page_url
                              ? _vm.dataList.next_page_url
                              : "#",
                            as: "button",
                            type: "button",
                            disabled: _vm.dataList.next_page_url ? false : true
                          }
                        },
                        [_c("i", { staticClass: "fa fa-chevron-right fa-fw" })]
                      ),
                      _vm._v(" "),
                      _c(
                        "Link",
                        {
                          staticClass: "btn btn-alt-secondary float-left",
                          attrs: {
                            href: _vm.dataList.prev_page_url
                              ? _vm.dataList.prev_page_url
                              : "#",
                            as: "button",
                            type: "button",
                            disabled: _vm.dataList.prev_page_url ? false : true
                          }
                        },
      ...
      _c(
        "div",
        {
          staticClass: "block block-rounded block-shadow-2 block-bordered mb-5"
        },
        [
          _c("div", { staticClass: "block-content px-0 py-0" }, [
            _c("input", {
              attrs: { type: "hidden", id: "current_page", value: "1" }
            }),
            _vm._v(" "),
            _c(
              "table",
              {
                staticClass:
                  "table table-striped table-vcenter table-hover mb-0 font-size-sm",
                attrs: { id: "data-list" }
              },
              [
                ...
                _c(
                  "tbody",
                  _vm._l(_vm.dataList.data, function(data) {
